...
pip3.6 download -d $PROJECT_ROOT/venv/pip_download -r $PROJECT_ROOT/osx_requirements.txt
pip3.6 install -f $PROJECT_ROOT/venv/pip_download -r $PROJECT_ROOT/osx_requirements.txt 
