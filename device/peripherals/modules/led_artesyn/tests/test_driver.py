...
from device.peripherals.modules.led_artesyn.driver import LEDArtesynDriver

# Load test config and setup
base_path = root_dir + "/device/peripherals/modules/led_artesyn/tests/"
